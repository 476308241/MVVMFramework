...
import com.finest.chatlibrary.util.BitmapCache;
...
public class VideoViewHolder<Message extends IMessage> extends BaseMessageViewHolder<Message>
    ...
    public VideoViewHolder(View itemView, boolean isSender) {
        ...
        mVideoContainer = (FrameLayout) itemView.findViewById(R.id.aurora_fl_msgitem_video_container);
        if (isSender) {
    ...
    public void onBind(final Message message) {
        ...
        if (mImageLoader != null) {
            mImageLoader.loadVideo(mImageCover, message);
        } else {
        ...
        mVideoContainer.setOnLongClickListener(new View.OnLongClickListener() {
